...
# bash tools/run.sh  configs/vitb_384_OVRSIS95K.yaml 4 output/ablation_pini_baseline_image_text_b/full_pini
...
#   2>&1 | tee ${BASE_OUTPUT}/${EXP_NAME}/train_log.txt
# bash tools/run.sh  configs/vitb_384_OVRSIS95K.yaml 4 output/ablation_pini_baseline_image_text_b/image_vpn_only
...
#   MODEL.PINI.TEXT_VPN_ENABLED True \
#   2>&1 | tee ${BASE_OUTPUT}/${EXP_NAME}/train_log.txt
# bash tools/run.sh  configs/vitb_384_OVRSIS95K.yaml 4 output/ablation_pini_baseline_image_text_b/text_vpn_only
...
#   2>&1 | tee ${BASE_OUTPUT}/${EXP_NAME}/train_log.txt
bash tools/run.sh  configs/vitb_384_OVRSIS95K.yaml 4 output/ablation_pini_baseline_image_text_b/baseline_no_pini
