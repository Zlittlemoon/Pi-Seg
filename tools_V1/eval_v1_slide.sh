...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-iSAID_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-DLRSD_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-Potsdam_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-Vaihingen_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-UDD5_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-LoveDA_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-uavid_slide \
...
python train_net.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval-VDD_slide \
...
cat $output/eval-iSAID_slide/log.txt | grep copypaste
cat $output/eval-DLRSD_slide/log.txt | grep copypaste
cat $output/eval-Potsdam_slide/log.txt | grep copypaste
cat $output/eval-Vaihingen_slide/log.txt | grep copypaste
cat $output/eval-UDD5_slide/log.txt | grep copypaste
cat $output/eval-LoveDA_slide/log.txt | grep copypaste
cat $output/eval-uavid_slide/log.txt | grep copypaste
cat $output/eval-VDD_slide/log.txt | grep copypaste
