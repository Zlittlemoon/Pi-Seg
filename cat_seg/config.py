...
def add_cat_seg_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.CLIP_PRETRAINED_DATASET = "ViT-B/16"
    ...
    # PiNI: feature-level VPN config
    cfg.MODEL.PINI = CN()
    cfg.MODEL.PINI.ENABLED = True
    cfg.MODEL.PINI.IMAGE_VPN_ENABLED = True
    cfg.MODEL.PINI.TEXT_VPN_ENABLED = True
    cfg.MODEL.PINI.REDUCTION = 1
    cfg.MODEL.PINI.TEXT_NOISE_STD = 0.02
    
    cfg.MODEL.PINI.IMAGE_NOISE_TYPE = "laplace"
    cfg.MODEL.PINI.IMAGE_STUDENT_T_DF = 3.0

    cfg.MODEL.PINI.TEXT_NOISE_TYPE = "uniform"
    cfg.MODEL.PINI.TEXT_STUDENT_T_DF = 3.0

    cfg.MODEL.PINI.IS_VIS = True
